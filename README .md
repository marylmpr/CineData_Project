...
Περιγραφή: ο χρήστης μπορεί να βλέπει συγκεντρωμένες όλες τις κριτικές και τις βαθμολογίες που έχουν υποβάλει όλοι οι χρήστες για τη συγκεκριμένη ταινία.

Είσοδος: ο χρήστης επιλέγει μια ταινία από τον κατάλογο και μεταβαίνει στην ενότητα του ιστορικού κριτικών της.

Έξοδος: η λίστα με το όνομα του χρήστη, το κείμενο της κριτικής, η ημερομηνία υποβολής και η βαθμολογία για τη συγκεκριμένη ταινία.
